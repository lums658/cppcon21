...
//
// Data and graph from OSPF example in Boost Graph Library book by
// Siek, Lee, and Lumsdaine
//

#ifndef NWGRAPH_OSPF_GRAPH_HPP
#define NWGRAPH_OSPF_GRAPH_HPP
