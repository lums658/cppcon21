//
// Taken from P1895R0 by Baker, Niebler, Shoop
// Some portions (c) Andrew Lumsdaine, Luke Dalessandro
//
...
//
// Implementation of tag_invoke for customization point objects
//

#ifndef NWGRAPH_TAG_INVOKE_HPP
#define NWGRAPH_TAG_INVOKE_HPP
